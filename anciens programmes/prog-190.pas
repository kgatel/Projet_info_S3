...
var a,r1,r2,t1,t11,t22,t2,i,j : integer;
	tab : tableau;
	k : Tkeyevent;
	x,y,cste,x3tab,y3tab,x4tab,y4tab,x5tab,y5tab,x6tab,y6tab,compteur : integer;
...
begin
	...
	begin prise_en_passant(xtab,x2tab,ytab,y2tab,x3tab,x4tab,y4tab,x5tab,x6tab,a,p1,p2,p3,p4,vf,prise_en_passant0) end;
		...
		begin
			...
			gotoxy(3,19);
			textbackground(0);textcolor(15);
			writeln('Joueur ',a,' a vous de joueur');
		end;
		...
		begin
				...
				begin
					repeat
					gotoxy(3,19);textbackground(0);textcolor(15);
				...
				begin
					...
					case a of
						1 : begin a:=2;gotoxy(3,19); write('Joueur ',a,' a vous de jouer'); end;
						2 : begin a:=1;gotoxy(3,19); write('Joueur ',a,' a vous de jouer'); end;
					end;
					compteur:=compteur+1;
				end; //end echec=false
...
procedure deplacement(tempsdebase1,tempsdebase2,temps_debut_program : integer ; var t,tt,ss,sss,minute,seconde,minute2,seconde2,delay1,delay2,delay11,delay22,tps_initial1,tps_initial2,x,y,cste,a,r1,r2,t1,t11,t2,t22,x3tab,y3tab,x4tab,y4tab,x5tab,y5tab,x6tab,y6tab,compteur : integer; var p3,p4 : string; var echecmat,prise_en_passant0,wsh1,wsh2: boolean);
	...
	gotoxy(3,19);textbackground(0);textcolor(15); writeln('Ou voulez-vous deplacer votre piece ?')	;
	gotoxy(x,y);
	...
	{curseur 2}
		repeat
			...
			case k of
				...
				33619749 : x:=x+4;
				33619747 : x:=x-4;
				7181 : begin deplacement2(tempsdebase1,tempsdebase2, delay1,delay2,temps_debut_program,t,tt,xtab,ytab,x3tab,y3tab,x4tab,y4tab,x5tab,y5tab,x6tab,y6tab,r1,r2,t1,t11,t2,t22,compteur,delay11,delay22,p1,p3,p4,cste,a,vf,echec,prise_en_passant0) end;
			end;
			end
			else
		...
		gotoxy(x,y);
			...
			until((k=11640)or (cste=1) or (cste=2));
	end;
end;
...
begin
	...
	begin{curseur}
		...
		case k of
				...
				33619749 : x:=x+4;
				33619747 : x:=x-4;
				7181 : deplacement(tempsdebase1,tempsdebase2,temps_debut_program,t,tt,ss,sss,minute,seconde,minute2,seconde2,delay1,delay2,delay11,delay22,tps_initial1,tps_initial2,x,y,cste,a,r1,r2,t1,t11,t2,t22,x3tab,y3tab,x4tab,y4tab,x5tab,y5tab,x6tab,y6tab,compteur,p3,p4,echecmat,prise_en_passant0,wsh1,wsh2);
		end;
		end
		else
		timer(a,tempsdebase1,tempsdebase2,temps_debut_program,delay11,delay22,t,tt,ss,sss,minute,seconde,minute2,seconde2,delay1,delay2,tps_initial1,tps_initial2,wsh1,wsh2);
		...
		until((k=4471) or (echecmat=true)or(pat0=true) or( (minute=0)and (seconde=0)) or((minute2=0)and(seconde2=0)));	
			
		if (minute=0) and (seconde=0) then
		begin
		gotoxy(3,19);textbackground(0);textcolor(15);
		writeln('Time out, partie terminee, Joueur 2 a gagne')
		end;
		
		if (minute2=0) and (seconde2=0) then
		begin
		gotoxy(3,19);textbackground(0);textcolor(15);
		writeln('Time out, partie terminee, Joueur 1 a gagne')
		end;
		
		if pat0=true then
		begin
		gotoxy(3,19);textbackground(0);textcolor(15);
		writeln('Pat ! Partie nulle          ');
		end;
		if k=4471 then
		begin
		gotoxy(3,19);textbackground(0);textcolor(15);
