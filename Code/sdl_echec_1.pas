...
procedure deplacement(var x,y,cste,a,r1,r2,t1,t11,t2,t22,x3tab,y3tab,x4tab,y4tab,x5tab,y5tab,x6tab,y6tab,compteur : integer; var p3,p4 : string; var echecmat,prise_en_passant0: boolean);
    ...
    CASE test_event^.type_ OF
      ...
      SDL_KEYDOWN: BEGIN
                     ...
                     case test_event^.key.keysym.sym of
						...
						27  : loop:=TRUE;
						13  : deplacement(x,y,cste,a,r1,r2,t1,t11,t2,t22,x3tab,y3tab,x4tab,y4tab,x5tab,y5tab,x6tab,y6tab,compteur,p3,p4,echecmat,prise_en_passant0);
						end;
